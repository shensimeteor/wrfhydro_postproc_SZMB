...
#SZFT: 2250x2250; 1350x1180+450+460 => 504x464 
...
ln -sf ${consdir}/nodeidx_SZFT.txt .
echo ncl 'srcfilename="??????????00.CHRTOUT_DOMAIN1"' 'colorbar_maxvalue=50' 'dom_name="SZFT"' 'nodeidx_file="nodeidx_SZFT.txt"' 'lonlat_list="114.0060,114.1238,22.5021,22.5856"' plot_streamflow_Customize_forTrans_noLegend2.ncl  
ncl 'srcfilename="??????????00.CHRTOUT_DOMAIN1"' 'colorbar_maxvalue=50' 'dom_name="SZFT"' 'nodeidx_file="nodeidx_SZFT.txt"' 'lonlat_list="114.0060,114.1238,22.5021,22.5856"' plot_streamflow_Customize_forTrans_noLegend2.ncl &> log.plt
...
cd overlayGE
ln -sf $consdir/pngs/SZFT/background.png .
ln -sf $consdir/pngs/SZFT/legend.png .
for png in $(ls ../before_overlay/*.png); do
    convert +repage -transparent "rgb(255,255,255)" -crop 1350x1180+450+460  -resize 504x464! $png inter.png
    ...
    echo cp GE_${pngtitle}.png $webdir/cycles/$cycle/$datx/SZFT_Streamflow.png
    cp GE_${pngtitle}.png $webdir/cycles/$cycle/$datx/SZFT_Streamflow.png
