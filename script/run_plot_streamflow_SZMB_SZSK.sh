...
#SZSK: 2250x2250; 1350x1285+450+410 => 684x678 
...
ln -sf ${consdir}/nodeidx_SZSK.txt .
echo ncl 'srcfilename="??????????00.CHRTOUT_DOMAIN1"' 'colorbar_maxvalue=50' 'dom_name="SZSK"' 'nodeidx_file="nodeidx_SZSK.txt"' 'lonlat_list="114.0755,114.2208,22.5472,22.6607"' plot_streamflow_Customize_forTrans_noLegend2.ncl  
ncl 'srcfilename="??????????00.CHRTOUT_DOMAIN1"' 'colorbar_maxvalue=50' 'dom_name="SZSK"' 'nodeidx_file="nodeidx_SZSK.txt"' 'lonlat_list="114.0755,114.2208,22.5472,22.6607"' plot_streamflow_Customize_forTrans_noLegend2.ncl &> log.plt
...
cd overlayGE
ln -sf $consdir/pngs/SZSK/background.png .
ln -sf $consdir/pngs/SZSK/legend.png .
for png in $(ls ../before_overlay/*.png); do
    convert +repage -transparent "rgb(255,255,255)" -crop 1350x1285+450+410  -resize 684x678! $png inter.png
    ...
    echo cp GE_${pngtitle}.png $webdir/cycles/$cycle/$datx/SZSK_Streamflow.png
    cp GE_${pngtitle}.png $webdir/cycles/$cycle/$datx/SZSK_Streamflow.png
    test -d "$webdir/gifs/$datx" || mkdir -p "$webdir/gifs/$datx" 
    test -e "$webdir/gifs/$datx/SZSK_Streamflow.png" && rm -rf "$webdir/gifs/$datx/SZSK_Streamflow.png"
    echo cp GE_${pngtitle}.png $webdir/gifs/$datx/SZSK_Streamflow.png
    cp GE_${pngtitle}.png $webdir/gifs/$datx/SZSK_Streamflow.png
    cp inter.png $webdir/gifs/$datx/SZSK_Streamflow_White.png
    rm inter.png inter2.png
done
touch $workdir/finished.streamflow_SZSK
